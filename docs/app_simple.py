"""
Colt Wayfinder Tool - API Backend (Simplified Version)

This module provides the FastAPI backend for the Colt Wayfinder tool.
Uses simplified search engine without scikit-learn dependencies.
"""
...
# Import our simplified search engine
from search_engine_simple import WayfinderSearchEngine
